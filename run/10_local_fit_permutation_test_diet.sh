...
exec conda run -n multiomics python scripts/fit_permutation_test.py \
    ...
    --model-logs "$D/21tdsqsa/diet_logging.txt" \
                 "$D/7o4yga2v/diet_logging.txt" \
                 "$D/8lofhbbf/diet_logging.txt" \
                 "$D/ai9n4jxs/diet_logging.txt" \
                 "$D/q2gzu1o3/diet_logging.txt" \
                 "$D/qb4y98x0/diet_logging.txt" \
                 "$D/wcksnlsg/diet_logging.txt" \
