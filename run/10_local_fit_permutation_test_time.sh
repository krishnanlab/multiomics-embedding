...
exec conda run -n multiomics python scripts/fit_permutation_test.py \
    ...
    --model-logs "$D/21tdsqsa/time_logging.txt" \
                 "$D/7o4yga2v/time_logging.txt" \
                 "$D/8lofhbbf/time_logging.txt" \
                 "$D/ai9n4jxs/time_logging.txt" \
                 "$D/q2gzu1o3/time_logging.txt" \
                 "$D/qb4y98x0/time_logging.txt" \
                 "$D/wcksnlsg/time_logging.txt" \
