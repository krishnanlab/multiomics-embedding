...
run_species_enrichment <- function(
  ...
  ##########################################################
  # Find matching taxonomy column
  ##########################################################
  
  taxonomy_column <- taxonomy_levels[[taxonomy_level]]
  
  ##########################################################
  # Species annotations inside the cluster
  ##########################################################
  ...
  ##########################################################
  # Species annotations outside the cluster
  ##########################################################
  ...
  ##########################################################
  # Test taxonomy terms observed in cluster
  ##########################################################
...
for(
  ...
  ##########################################################
  # Taxonomy enrichment for every cluster and level
  ##########################################################
  ...
  for(
    ...
    background_features <- as.character(
...
############################################################
# Combine taxonomy enrichment results
############################################################
...
if(
  ...
  ##########################################################
  # Write separate files for every taxonomy level
  #
