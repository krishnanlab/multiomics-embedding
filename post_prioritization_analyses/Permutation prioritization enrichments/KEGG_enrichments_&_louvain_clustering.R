...
############################################################
# Force relevant columns to character
############################################################
...
############################################################
# Extract KEGG, METLIN, and HMP IDs
############################################################
...
############################################################
# Fill missing KEGG IDs using METLIN mappings
############################################################
...
############################################################
# Remove temporary conversion field
############################################################
...
############################################################
# Map original IDs to KEGG for enrichment only
############################################################
...
############################################################
# Preserve original embedding IDs
############################################################
...
############################################################
# Save/check mapping of embedding universe
############################################################
...
############################################################
# Ensure matching columns are character
############################################################
...
############################################################
# Filter KEGG annotations to used features
############################################################
...
run_KEGG_enrichment <- function(
  ...
  ##########################################################
  # Convert graph node IDs to KEGG where available
  ##########################################################
...
############################################################
# Save raw key including parsed IDs
############################################################
...
############################################################
# Save embedding/background lookup
############################################################
